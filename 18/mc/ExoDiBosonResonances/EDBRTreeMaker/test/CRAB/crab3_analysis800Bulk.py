...
config.General.requestName   = 'BulkGravWW800-v'
...
config.Data.inputDataset = '/BulkGravToWWToWlepWhad_narrow_M-800_13TeV-madgraph/RunIISummer16MiniAODv2-PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/MINIAODSIM'
...
config.Data.outputDatasetTag = 'BulkGravWW800'
