...
EDBRTreeMaker::EDBRTreeMaker(const edm::ParameterSet& iConfig):
  ...
  muPaths10_(iConfig.getParameter<std::vector<std::string>>("muPaths10")),//  noiseFilterToken_(consumes<edm::TriggerResults>(iConfig.getParameter<edm::InputTag>("noiseFilter")))
...
//  outTree_->Branch("passFilter_badChargedHadron"                 ,&passFilter_badChargedHadron_                ,"passFilter_badChargedHadron_/O");
  ...
  */
    if (RunOnMC_){
        ...
        outTree_->Branch("massgenzl"           ,massgenzl         ,"massgenzl[5]/D"          );
        outTree_->Branch("taggenzl"           ,taggenzl         ,"taggenzl[5]/D"          );
        outTree_->Branch("taggl"           ,taggl         ,"taggl[15]/I"          );
        outTree_->Branch("ptgengl"           ,ptgengl         ,"ptgengl[15]/D"          );
        outTree_->Branch("etagengl"           ,etagengl         ,"etagengl[15]/D"          );
        outTree_->Branch("phigengl"           ,phigengl       ,"phigengl[15]/D"          );
        outTree_->Branch("egengl"           ,egengl         ,"egengl[15]/D"          );
        ...
        outTree_->Branch("tagq1l"           ,tagq1l         ,"tagq1l[5]/I"          );
        outTree_->Branch("tagq2l"           ,tagq2l         ,"tagq2l[5]/I"          );
        outTree_->Branch("tagq3l"           ,tagq3l         ,"tagq3l[5]/I"          );
        outTree_->Branch("tagq4l"           ,tagq4l         ,"tagq4l[5]/I"          );
        outTree_->Branch("tagq5l"           ,tagq5l         ,"tagq5l[5]/I"          );
...
//  outTree_->Branch("massGenVlep"        ,&massGenVlep       ,"massGenVlep/D"       );
  ...
  outTree_->Branch("pweight" ,pweight ,"pweight[1080]/D" );
  }
}
/*
...
EDBRTreeMaker::tightJetID( const pat::Jet& j ) {
         if(j.pt()>170.){
                 ...
                 int CHM = j.chargedMultiplicity();
                 double eta = j.eta();
                 return ( (abs(eta)<=2.4 && NHF<0.9 && NEMF<0.9 && NumConst>1 && MUF<0.8 && CHF>0 && CHM>0 && CEMF<0.8) || (abs(eta)>2.4 && abs(eta)<=2.7 && NHF<0.9 && NEMF<0.9 && NumConst>1 && MUF<0.8) || (abs(eta)>2.7 && abs(eta)<=3.0 && NHF<0.99) || (abs(eta)>3.0 && NEMF<0.90 && NHF>0.02 && NumNeutralParticle>2 && NumNeutralParticle<15) );
                        }
         else{
                 return (0);
             }
...
EDBRTreeMaker::tightJetID_ak4( const pat::Jet& j ) {
         if(j.pt()>0.){
                 ...
                 int CHM = j.chargedMultiplicity();
                 double eta = j.eta();
                 return ( (abs(eta)<=2.4 && NHF<0.9 && NEMF<0.9 && NumConst>1 && MUF<0.8 && CHF>0 && CHM>0 && CEMF<0.8) || (abs(eta)>2.4 && abs(eta)<=2.7 && NHF<0.9 && NEMF<0.9 && NumConst>1 && MUF<0.8) || (abs(eta)>2.7 && abs(eta)<=3.0 && NEMF<0.99 && NEMF>0.02 && NumNeutralParticle>2) || (abs(eta)>3.0 && NEMF<0.90 && NHF>0.02 && NumNeutralParticle>10) );
                        }
         else{
                 return (0);
             }
...
//   int wid[254]={1001, 1002, 1003, 1004, 1005, 1006, 1007, 1008, 1009, 2001, 2002, 2003, 2004, 2005, 2006, 2007, 2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025, 2026, 2027, 2028, 2029, 2030, 2031, 2032, 2033, 2034, 2035, 2036, 2037, 2038, 2039, 2040, 2041, 2042, 2043, 2044, 2045, 2046, 2047, 2048, 2049, 2050, 2051, 2052, 2053, 2054, 2055, 2056, 2057, 2058, 2059, 2060, 2061, 2062, 2063, 2064, 2065, 2066, 2067, 2068, 2069, 2070, 2071, 2072, 2073, 2074, 2075, 2076, 2077, 2078, 2079, 2080, 2081, 2082, 2083, 2084, 2085, 2086, 2087, 2088, 2089, 2090, 2091, 2092, 2093, 2094, 2095, 2096, 2097, 2098, 2099, 2100, 2101, 2102, 3001, 3002, 3003, 3004, 3005, 3006, 3007, 3008, 3009, 3010, 3011, 3012, 3013, 3014, 3015, 3016, 3017, 3018, 3019, 3020, 3021, 3022, 3023, 3024, 3025, 3026, 3027, 3028, 3029, 3030, 3031, 3032, 3033, 3034, 3035, 3036, 3037, 3038, 3039, 3040, 3041, 3042, 3043, 3044, 3045, 3046, 3047, 3048, 3049, 3050, 3051, 3052, 3053, 3054, 3055, 3056, 3057, 3058, 3059, 3060, 4001, 4002, 4003, 4004, 4005, 4006, 4007, 4008, 4009, 4010, 4011, 4012, 4013, 4014, 4015, 4016, 4017, 4018, 4019, 4020, 4021, 4022, 4023, 4024, 4025, 4026, 4027, 4028, 4029, 4030, 4031, 4032, 4033, 4034, 4035, 4036, 4037, 4038, 4039, 4040, 4041, 4042, 4043, 4044, 4045, 4046, 4047, 4048, 4049, 4050, 4051, 4052, 4053, 4054, 4055, 4056, 5001, 5002, 5003, 5004, 5005, 5006, 5007, 5008, 5009, 5010, 5011, 5012, 5013, 5014, 5015, 5016, 5017, 5018, 5019, 5020, 5021, 5022, 5023, 5024, 5025, 5026, 5027};
    ...
    //w and top info
        ...
        for(size_t ik=0; ik<genParticles->size();ik++)
        {
            if(abs((*genParticles)[ik].pdgId())==21)
            {
                ...
                if(pgtmp->pt()>50&&igeng<sizeg&&goverlap==0){
                    ...
                    if(abs(pgtmp2->mother(0)->pdgId())<=5&&abs(pgtmp2->mother(0)->pdgId())>0){taggl[igeng]=1;}
                    else{taggl[igeng]=0;}
                 //   cout<<"taggl "<<taggl[igeng]<<endl;
        ...
        for(size_t ik=0; ik<genParticles->size();ik++)
        {
                if(abs((*genParticles)[ik].pdgId())==1)
                {
                    ...
                    if(abs(pgtmp2->mother(0)->pdgId())==21){tagq1l[igenq1]=1;}
                    else{tagq1l[igenq1]=0;}
                  //  cout<<"tagq1l "<<tagq1l[igenq1]<<endl;
            ...
            for(size_t ik=0; ik<genParticles->size();ik++)
            {
                if(abs((*genParticles)[ik].pdgId())==2)
                {
                    ...
                    if(abs(pgtmp2->mother(0)->pdgId())==21){tagq2l[igenq2]=1;}
                    else{tagq2l[igenq2]=0;}
                  //  cout<<"tagq2l "<<tagq2l[igenq2]<<endl;
            ...
            for(size_t ik=0; ik<genParticles->size();ik++)
            {
                if(abs((*genParticles)[ik].pdgId())==3)
                {
                    ...
                    if(abs(pgtmp2->mother(0)->pdgId())==21){tagq3l[igenq3]=1;}
                    else{tagq3l[igenq3]=0;}
                 //   cout<<"tagq3l "<<tagq3l[igenq3]<<endl;
            ...
            for(size_t ik=0; ik<genParticles->size();ik++)
            {
                if(abs((*genParticles)[ik].pdgId())==4)
                {
                    ...
                    if(abs(pgtmp2->mother(0)->pdgId())==21){tagq4l[igenq4]=1;}
                    else{tagq4l[igenq4]=0;}
                 //   cout<<"tagq4l "<<tagq4l[igenq4]<<endl;
            ...
            for(size_t ik=0; ik<genParticles->size();ik++)
            {
                if(abs((*genParticles)[ik].pdgId())==5)
                {
                    ...
                    if(abs(pgtmp2->mother(0)->pdgId())==21){tagq5l[igenq5]=1;}
                    else{tagq5l[igenq5]=0;}
                 //   cout<<"tagq5l "<<tagq5l[igenq5]<<endl;
...
void EDBRTreeMaker::setDummyValues() {
    ...
    for(int i=0;i<15;i++){
        ptgengl[i]=-99;etagengl[i]=-99;phigengl[i]=-99;egengl[i]=-99;taggl[i]=-99;
        ptgengf[i]=-99;etagengf[i]=-99;phigengf[i]=-99;egengf[i]=-99;
        mothergengf[i]=-99;mmothergengf[i]=-99;
    }
    for(int i=0;i<5;i++){
        ptgenq1l[i]=-99;etagenq1l[i]=-99;phigenq1l[i]=-99;egenq1l[i]=-99;tagq1l[i]=-99;
        ptgenq1f[i]=-99;etagenq1f[i]=-99;phigenq1f[i]=-99;egenq1f[i]=-99;
        ptgenq2l[i]=-99;etagenq2l[i]=-99;phigenq2l[i]=-99;egenq2l[i]=-99;tagq2l[i]=-99;
        ptgenq2f[i]=-99;etagenq2f[i]=-99;phigenq2f[i]=-99;egenq2f[i]=-99;
        ptgenq3l[i]=-99;etagenq3l[i]=-99;phigenq3l[i]=-99;egenq3l[i]=-99;tagq3l[i]=-99;
        ptgenq3f[i]=-99;etagenq3f[i]=-99;phigenq3f[i]=-99;egenq3f[i]=-99;
        ptgenq4l[i]=-99;etagenq4l[i]=-99;phigenq4l[i]=-99;egenq4l[i]=-99;tagq4l[i]=-99;
        ptgenq4f[i]=-99;etagenq4f[i]=-99;phigenq4f[i]=-99;egenq4f[i]=-99;
        ptgenq5l[i]=-99;etagenq5l[i]=-99;phigenq5l[i]=-99;egenq5l[i]=-99;tagq5l[i]=-99;
