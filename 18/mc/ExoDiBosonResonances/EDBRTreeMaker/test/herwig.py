...
config.General.requestName   = 'herwig'
...
config.Data.inputDataset = '/QCD_Pt-15to7000_TuneCH3_Flat_13TeV_herwig7/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM'
...
config.Data.outputDatasetTag = 'herwig'
