...
config.General.requestName   = 'M1500_R0-7'
...
config.Data.inputDataset = '/WkkToWRadionToWWW_M1500-R0-7-TuneCUEP8M1_13TeV-madgraph/RunIISummer16MiniAODv2-PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/MINIAODSIM'
...
name='WWW'
steam_dir='chench'
config.Data.outLFNDirBase='/store/group/phys_b2g/chench/'#/'#='/store/group/phys_b2g/chench/'#/'#='/store/group/dpg_trigger/comm_trigger/TriggerStudiesGroup/STEAM/'+steam_dir+'/'+name+'/'
#config.Data.outLFNDirBase='/store/group/phys_b2g/chench/'#/'#='/store/group/phys_b2g/chench/'#/'#='/eos/uscms/store/user/jingli/chench/'
config.Data.publication = False
config.Data.outputDatasetTag = 'M1500_R0-7'
