...
config.Data.inputDataset = '/TTJets_TuneCP5_13TeV-amcatnloFXFX-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15_ext2-v1/MINIAODSIM'
...
name='WWW'
steam_dir='chench'
config.Data.outLFNDirBase='/store/group/phys_b2g/chench/TT_18/'
