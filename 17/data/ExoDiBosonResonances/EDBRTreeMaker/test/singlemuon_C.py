...
config.General.requestName   = '17C-v1_singlemuon'
...
#config.Data.inputDataset = '/JetHT/Run2017C-23Sep2017-v1/MINIAOD'
...
config.Data.outputDatasetTag = '17C-v1_singlemuon'
