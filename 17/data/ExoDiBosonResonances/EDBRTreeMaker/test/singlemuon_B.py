...
config.General.requestName   = '17B-v1_singlemuon'
...
#config.Data.inputDataset = '/JetHT/Run2017B-23Sep2017-v1/MINIAOD'
...
config.Data.outputDatasetTag = '17B-v1_singlemuon'
